...
- Tenant profile: name, mobile, date of birth, parent's mobile, home address, arrival date, university, course, graduation month/year, referee name/contact/location. Email and monthly rent remain necessary for sign-in and billing. Existing room and bond data are preserved.
